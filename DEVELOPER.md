...
3. Build the documentation PDF with `build-pdf.sh` from the `doc/` directory. This script runs multiple passes of `pdflatex` and `bibtex` to build the PDF document:
