...
# original SFR input. This is a generalized function that can be used to convert
# MF2K5-based model to the new MF6 format.  Currently applied to the Sagehen and 
# modsim models
