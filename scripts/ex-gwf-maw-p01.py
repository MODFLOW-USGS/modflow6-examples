...
k33 = 1.e-16  # Vertical hydraulic conductivity ($m/d$)
...
maw_packagedata = [
    [0, maw_radius, botm[-1], strt[-1], "THIEM", 2]
]

maw_conn = [
    [0, 0, 0, maw_row, maw_col, top, botm[-1], -999., -999.],
    [0, 1, 1, maw_row, maw_col, top, botm[-1], -999., -999.],
]
...
def build_model(name, rate=0.):
    if config.buildModel:
        ...
        gwf = flopy.mf6.ModflowGwf(
            sim, modelname=sim_name, save_flows=True
        )
