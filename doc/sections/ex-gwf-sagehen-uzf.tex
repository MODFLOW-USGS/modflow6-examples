...
A summary of model parameter values are listed in table~\ref{tab:ex-gwf-sagehen-uzf-01.tex}. Interested readers are referred to \cite{UZF} for a discussion of additional details, including howthe distribution of hydraulic conductivity was derived and aspects of the model calibration, among others.
